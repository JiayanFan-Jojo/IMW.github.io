/*
    ...
    Created: 07 Feb 2025
    Description: stalled site tracker js page for DDC&UI Products
...
const map = new mapboxgl.Map({
  container: 'map',
  style: 'mapbox://styles/jojoowo/cm70ihxb300re01s1eo876i6y',
...
function loadCSVData() {
  return new Promise((resolve, reject) => {
    Papa.parse("data/stalled/site_info.csv", {
      download: true,
      header: true,
      skipEmptyLines: true,
      complete: (results) => {
